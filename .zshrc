    ...
    while getopts ":hao" opt; do
        case $opt in
            ...
            h)
                ...
                printf '  -a      replace '\'' ; '\'' sequences with '\'' ; '\''.\n'
                printf '          be careful using this option.\n'
                printf '  -o      only sets an alias if a preceding would be needed.\n'
                return 0
                ;;
            *) salias -h >&2; return 1 ;;
        esac
...
then
	path=$(find / -type d -regex ".*Documents/GitHub/dot_files" 2> /dev/null)	# retrieve the path of the directory that contains the configuration files
